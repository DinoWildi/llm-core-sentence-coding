...
rel_sysprompt = f'''
You are an expert annotator for political content in newspaper texts.
Your task is to identify political claims made in British newspapers published between November 2025 and February 2026 according to the following codebook. Identify all relations between different actors, and actors and issues.
Return only relations that involve at least one actor relevant to British national politics (e.g. a party, a politician, a social movement, or an interest group).

## Coding instructions

Identify relations in the text, using the following codebook. Do not code relations that do not fit one of the categories below.
